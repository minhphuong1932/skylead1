...
include_once(ROOT_PATH."classes/dao/consultantinfo.class.php");
...
class Consultant extends Model {
	...
	public function __construct($store_id = 0, $database = '') {
		...
		$this->table = DB_PREFIX."consultant";
		$this->store_id = $store_id;
	}
	public function Consultants($store_id = 0, $database = '') {

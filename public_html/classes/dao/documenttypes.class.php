...
include_once(ROOT_PATH.'classes/dao/documenttypeinfo.class.php');
...
class DocumentType extends Model {
	...
	public function __construct($database = '') {
		...
		$this->table = DB_PREFIX."document_type";
	}
	public function DocumentType($database = '') {

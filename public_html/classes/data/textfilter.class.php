<?php
	...
	class TextFilter  
	{
		...
		{
			$this->__construct($removeJavaScript,$htmlAllowedTags);
		}
...
#End edited by Mai Minh for Vietnamese
		   ...
		   function urlize2( $string, $domainize = false, $separator = "_" )
        {
            // remove unnecessary spaces and make everything lower case
            $string = preg_replace( "/ +/", " ", strtolower($string) );
...
#End edited by Mai Minh for Vietnamese
        ...
        function urlize3( $string, $domainize = false, $separator = "_" )
        {
            // remove unnecessary spaces and make everything lower case
            $string = preg_replace( "/ +/", " ", strtolower($string) );

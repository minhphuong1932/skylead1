<?php /* Smarty version Smarty-3.0-RC2, created on 2022-04-12 14:56:18
         compiled from "./templates/admin/manageconsultantlist.tpl.html" */ ?>
<?php /*%%SmartyHeaderCode:1984021721625530a2c36f67-63539430%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f976d9e7127969130eae6aeed52c25e3651e7258' => 
    array (
      0 => './templates/admin/manageconsultantlist.tpl.html',
      1 => 1649750177,
    ),
  ),
  'nocache_hash' => '1984021721625530a2c36f67-63539430',
  'function' => 
  array (
  ),
...
<th><a href="javascript:void(0)" onClick="javascript:MM_sortField('parent','<?php echo $_smarty_tpl->getVariable('sk')->value;?>
','province','<?php if ($_smarty_tpl->getVariable('sd')->value=="DESC"){?>ASC<?php }else{ ?>DESC<?php }?>');" title="<?php echo $_smarty_tpl->getVariable('locale')->value->msg('provinces');?>
"><?php echo $_smarty_tpl->getVariable('locale')->value->msg('provinces');?>
</a><?php if ($_smarty_tpl->getVariable('sk')->value=="province"){?><?php if ($_smarty_tpl->getVariable('sd')->value=="DESC"){?>&darr;<?php }else{ ?>&uarr;<?php }?><?php }?></th>
<th><a href="javascript:void(0)" onClick="javascript:MM_sortField('parent','<?php echo $_smarty_tpl->getVariable('sk')->value;?>
','date_created','<?php if ($_smarty_tpl->getVariable('sd')->value=="DESC"){?>ASC<?php }else{ ?>DESC<?php }?>');" title="<?php echo $_smarty_tpl->getVariable('locale')->value->msg('date_created');?>
...
<td><?php echo $_smarty_tpl->getVariable('item')->value->getProvince();?>
 </td>

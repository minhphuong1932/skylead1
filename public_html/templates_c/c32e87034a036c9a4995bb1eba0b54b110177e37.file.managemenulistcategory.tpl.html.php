<?php /* Smarty version Smarty-3.0-RC2, created on 2021-11-13 10:31:02
         compiled from "./templates/admin/managemenulistcategory.tpl.html" */ ?>
<?php /*%%SmartyHeaderCode:1440399745618f317664db59-91239226%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c32e87034a036c9a4995bb1eba0b54b110177e37' => 
    array (
      0 => './templates/admin/managemenulistcategory.tpl.html',
      1 => 1635911791,
    ),
  ),
  'nocache_hash' => '1440399745618f317664db59-91239226',
  'function' => 
  array (
  ),
...
<?php if ($_smarty_tpl->getVariable('cId')->value){?><p><a href="/<?php echo $_smarty_tpl->getVariable('aScript')->value;?>
?op=manage&act=menu&mod=listcategory&cId=0" title="<?php echo $_smarty_tpl->getVariable('locale')->value->msg('back_group');?>
...
<th><?php echo $_smarty_tpl->getVariable('locale')->value->msg('num_menu_active');?>
</th>
...
?op=manage&act=menu&mod=list&cId=<?php echo $_smarty_tpl->getVariable('item')->value->getId();?>
&lang=<?php echo $_smarty_tpl->getVariable('lang')->value;?>
" title="<?php echo $_smarty_tpl->getVariable('locale')->value->msg('list_menu');?>
"><img src="/<?php echo $_smarty_tpl->getVariable('templatePath')->value;?>
/<?php echo $_smarty_tpl->getVariable('userTemplate')->value;?>
/images/ico_list.png" alt="<?php echo $_smarty_tpl->getVariable('locale')->value->msg('list_menu');?>
" width="16" height="16" /></a>
</td>
</tr>
<?php }} ?>
